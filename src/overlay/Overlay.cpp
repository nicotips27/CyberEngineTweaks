...
void Overlay::DrawToolbar()
{
    ...
    if (ImGui::Button("Consola", ImVec2(itemWidth, 0)))
        m_console.Toggle();
    if (!m_toggled)
    ...
    if (ImGui::Button("Enlaces", ImVec2(itemWidth, 0)))
        m_bindings.Toggle();
    if (!m_toggled)
    ...
    if (ImGui::Button("Ajustes", ImVec2(itemWidth, 0)))
        m_settings.Toggle();
    if (!m_toggled)
    ...
    if (ImGui::Button("Editor TweakDB", ImVec2(itemWidth, 0)))
    ...
    if (ImGui::Button("Registro Juego", ImVec2(itemWidth, 0)))
        m_gameLog.Toggle();
    if (!m_toggled)
    ...
    if (ImGui::Button("Depuración ImGui", ImVec2(itemWidth, 0)))
        m_imguiDebug.Toggle();
    if (!m_toggled)
    ...
    if (ImGui::Button("Recargar mods", ImVec2(itemWidth, 0)))
        m_vm.ReloadAllMods();
}
